...
file_to_save = os.path.join("..", "analysis", "election_analysis_with_counties.txt")
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in county_directory:

            # 4b: Add the existing county to the list of counties.
            county_directory.append(county_name)
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > largest_county_count) and (vote_percentage_county > largest_county_percentage):
